...
for folder_path in folder_paths:
    ...
    try:
        cursor = db.cursor()
        insert_str = "insert into poc_test(trigger_method, test_platform, software_version, record, title, author, code_language, reference, time, tag, CVE_ID, Verified, bugid, source, other_information) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s)"
